...
public class BlockModel extends Model<BlockModel>{
    ...
    public BlockModel defaultCube(String textureName){
        return new BlockModel(name).setParent(BlockModelParents.CUBE_ALL).addTexture("all", textureName);
    }
    ...
    public BlockModel log(@Nonnull String sideTexture, @Nonnull String endTexture){
        return new BlockModel(name).setParent(BlockModelParents.CUBE_COLUMN).addTextures(new KeyValue<>("end", endTexture), new KeyValue<>("side", sideTexture));
    }
    ...
    public BlockModel sapling(@Nonnull String textureName){
        return new BlockModel(name).setParent(BlockModelParents.CROSS).addTexture("cross", textureName).setRenderType("cutout");
    }
    ...
    public BlockModel wood(@Nonnull String textureName){
        return new BlockModel(name).setParent(BlockModelParents.CUBE_COLUMN).addTextures(new KeyValue<>("end", textureName), new KeyValue<>("side", textureName));
    }
